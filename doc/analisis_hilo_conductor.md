...
<svg viewBox="0 0 600 520" width="100%" style="max-width: 600px; font-family: system-ui, sans-serif; display: block; margin: 0 auto;">
  <!-- Title -->
  <rect x="50" y="10" width="500" height="35" rx="5" fill="#00ffaa"/>
  <text x="300" y="33" text-anchor="middle" font-size="16" font-weight="bold" fill="#0f0f1a">ARCO NARRATIVO</text>

  <!-- Part I - Lightest cyan (abstract) -->
  <rect x="100" y="60" width="400" height="55" rx="8" fill="#00aa77" opacity="0.4"/>
  <rect x="100" y="60" width="400" height="55" rx="8" fill="none" stroke="#00ffaa" stroke-width="2"/>
  <text x="120" y="82" font-size="12" font-weight="bold" fill="#00ffaa">PARTE I: ¿POR QUÉ?</text>
  <text x="120" y="98" font-size="10" fill="#e0e0e0">Principios filosóficos de la descentralización</text>
  <text x="120" y="110" font-size="9" fill="#888">(Descentralización, Autonomía, Libertad, Universalidad)</text>

  <!-- Arrow 1 -->
  <path d="M300 115 L300 130" stroke="#00ffaa" stroke-width="2" marker-end="url(#arrow-glow)"/>

  <!-- Part II -->
  <rect x="100" y="135" width="400" height="55" rx="8" fill="#00aa77" opacity="0.5"/>
  <rect x="100" y="135" width="400" height="55" rx="8" fill="none" stroke="#00ffaa" stroke-width="2"/>
  <text x="120" y="157" font-size="12" font-weight="bold" fill="#00ffaa">PARTE II: ¿QUÉ ESTÁ PASANDO?</text>
  <text x="120" y="173" font-size="10" fill="#e0e0e0">Panorama global: regulaciones, tecnología, tensiones</text>
  <text x="120" y="185" font-size="9" fill="#888">(China prohíbe, Wyoming innova, UE regula)</text>

  <!-- Arrow 2 -->
  <path d="M300 190 L300 205" stroke="#00ffaa" stroke-width="2" marker-end="url(#arrow-glow)"/>

  <!-- Part III -->
  <rect x="100" y="210" width="400" height="55" rx="8" fill="#00aa77" opacity="0.6"/>
  <rect x="100" y="210" width="400" height="55" rx="8" fill="none" stroke="#00ffaa" stroke-width="2"/>
  <text x="120" y="232" font-size="12" font-weight="bold" fill="#00ffaa">PARTE III: ¿CON QUÉ HERRAMIENTAS?</text>
  <text x="120" y="248" font-size="10" fill="#e0e0e0">Elementos constitutivos de la DI SOCIETA</text>
  <text x="120" y="260" font-size="9" fill="#888">(DAOs, Smart Contracts, Tokens, Gobernanza, Kleros)</text>

  <!-- Arrow 3 -->
  <path d="M300 265 L300 280" stroke="#00ffaa" stroke-width="2" marker-end="url(#arrow-glow)"/>

  <!-- Part IV -->
  <rect x="100" y="285" width="400" height="55" rx="8" fill="#00aa77" opacity="0.7"/>
  <rect x="100" y="285" width="400" height="55" rx="8" fill="none" stroke="#00ffaa" stroke-width="2"/>
  <text x="120" y="307" font-size="12" font-weight="bold" fill="#00ffaa">PARTE IV: ¿CÓMO INTEGRAR?</text>
  <text x="120" y="323" font-size="10" fill="#e0e0e0">Marcos de integración</text>
  <text x="120" y="335" font-size="9" fill="#888">(Wyoming, Lex Societa, NEBUAH)</text>

  <!-- Arrow 4 -->
  <path d="M300 340 L300 355" stroke="#00ffaa" stroke-width="2" marker-end="url(#arrow-glow)"/>

  <!-- Part V -->
  <rect x="100" y="360" width="400" height="55" rx="8" fill="#00aa77" opacity="0.8"/>
  <rect x="100" y="360" width="400" height="55" rx="8" fill="none" stroke="#00ffaa" stroke-width="2"/>
  <text x="120" y="382" font-size="12" font-weight="bold" fill="#00ffaa">PARTE V: ¿DÓNDE APLICAR?</text>
  <text x="120" y="398" font-size="10" fill="#e0e0e0">Aplicaciones prácticas genéricas</text>
  <text x="120" y="410" font-size="9" fill="#888">(Cooperativas, fondos, trazabilidad)</text>

  <!-- Arrow 5 -->
  <path d="M300 415 L300 430" stroke="#00ffaa" stroke-width="2" marker-end="url(#arrow-glow)"/>

  <!-- Part VI - Brightest (concrete) -->
  <rect x="100" y="435" width="400" height="55" rx="8" fill="#00ffaa" opacity="0.9"/>
  <text x="120" y="457" font-size="12" font-weight="bold" fill="#0f0f1a">PARTE VI: ¿CÓMO LO HACEMOS EN ARGENTINA?</text>
  <text x="120" y="473" font-size="10" fill="#1a1a2e">Implementaciones concretas por nivel de gobierno</text>
  <text x="120" y="485" font-size="9" fill="#2a2a3e">(Municipal → Provincial → Nacional → Internacional)</text>

  <!-- Arrow marker definition -->
  <defs>
    <marker id="arrow-glow" markerWidth="10" markerHeight="10" refX="5" refY="5" orient="auto-start-reverse">
      <path d="M0,0 L10,5 L0,10 z" fill="#00ffaa"/>
    </marker>
  </defs>

  <!-- Side labels -->
  <text x="55" y="280" font-size="10" fill="#00ffaa" writing-mode="vertical-rl" transform="rotate(180, 55, 280)">De lo abstracto a lo concreto →</text>
  <text x="545" y="280" font-size="10" fill="#00ffaa" writing-mode="vertical-rl">← De lo global a lo local</text>
</svg>
</div>
